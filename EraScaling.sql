...
-- Scale food, production and gold by +3% per difficulty per era.
INSERT INTO ModifierArguments (ModifierId, Name, Type, Value, Extra) VALUES
("FOOD_SCALING_CLASSICAL", "Amount", "LinearScaleFromDefaultHandicap", 0, 3),
("FOOD_SCALING_MEDIEVAL", "Amount", "LinearScaleFromDefaultHandicap", 0, 3),
("FOOD_SCALING_RENAISSANCE", "Amount", "LinearScaleFromDefaultHandicap", 0, 3),
("FOOD_SCALING_INDUSTRIAL", "Amount", "LinearScaleFromDefaultHandicap", 0, 3),
("FOOD_SCALING_MODERN", "Amount", "LinearScaleFromDefaultHandicap", 0, 3),
("FOOD_SCALING_ATOMIC", "Amount", "LinearScaleFromDefaultHandicap", 0, 3),
("FOOD_SCALING_INFO", "Amount", "LinearScaleFromDefaultHandicap", 0, 3),
("FOOD_SCALING_FUTURE", "Amount", "LinearScaleFromDefaultHandicap", 0, 3),
("PRODUCTION_SCALING_CLASSICAL", "Amount", "LinearScaleFromDefaultHandicap", 0, 3),
("PRODUCTION_SCALING_MEDIEVAL", "Amount", "LinearScaleFromDefaultHandicap", 0, 3),
("PRODUCTION_SCALING_RENAISSANCE", "Amount", "LinearScaleFromDefaultHandicap", 0, 3),
("PRODUCTION_SCALING_INDUSTRIAL", "Amount", "LinearScaleFromDefaultHandicap", 0, 3),
("PRODUCTION_SCALING_MODERN", "Amount", "LinearScaleFromDefaultHandicap", 0, 3),
("PRODUCTION_SCALING_ATOMIC", "Amount", "LinearScaleFromDefaultHandicap", 0, 3),
("PRODUCTION_SCALING_INFO", "Amount", "LinearScaleFromDefaultHandicap", 0, 3),
("PRODUCTION_SCALING_FUTURE", "Amount", "LinearScaleFromDefaultHandicap", 0, 3),
("GOLD_SCALING_CLASSICAL", "Amount", "LinearScaleFromDefaultHandicap", 0, 3),
("GOLD_SCALING_MEDIEVAL", "Amount", "LinearScaleFromDefaultHandicap", 0, 3),
("GOLD_SCALING_RENAISSANCE", "Amount", "LinearScaleFromDefaultHandicap", 0, 3),
("GOLD_SCALING_INDUSTRIAL", "Amount", "LinearScaleFromDefaultHandicap", 0, 3),
("GOLD_SCALING_MODERN", "Amount", "LinearScaleFromDefaultHandicap", 0, 3),
("GOLD_SCALING_ATOMIC", "Amount", "LinearScaleFromDefaultHandicap", 0, 3),
("GOLD_SCALING_INFO", "Amount", "LinearScaleFromDefaultHandicap", 0, 3),
("GOLD_SCALING_FUTURE", "Amount", "LinearScaleFromDefaultHandicap", 0, 3);

-- Scale science, culture and faith by +2% per difficulty per era.
INSERT INTO ModifierArguments (ModifierId, Name, Type, Value, Extra) VALUES
("SCIENCE_SCALING_CLASSICAL", "Amount", "LinearScaleFromDefaultHandicap", 0, 2),
...
("FAITH_SCALING_CLASSICAL", "Amount", "LinearScaleFromDefaultHandicap", 0, 2),
("FAITH_SCALING_MEDIEVAL", "Amount", "LinearScaleFromDefaultHandicap", 0, 2),
("FAITH_SCALING_RENAISSANCE", "Amount", "LinearScaleFromDefaultHandicap", 0, 2),
("FAITH_SCALING_INDUSTRIAL", "Amount", "LinearScaleFromDefaultHandicap", 0, 2),
("FAITH_SCALING_MODERN", "Amount", "LinearScaleFromDefaultHandicap", 0, 2),
("FAITH_SCALING_ATOMIC", "Amount", "LinearScaleFromDefaultHandicap", 0, 2),
("FAITH_SCALING_INFO", "Amount", "LinearScaleFromDefaultHandicap", 0, 2);
("FAITH_SCALING_FUTURE", "Amount", "LinearScaleFromDefaultHandicap", 0, 2);
